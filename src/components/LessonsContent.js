        ...
        {expanded && (
          <div className="flex flex-col space-y-5">
            ...
            <span className="text-lg">
              ...
              the audience to get a peak at what type of content you can
              provide. More importantly, they are what users see before deciding
              on whether or not to click on your content.
            </span>
            ...
            <span className="text-lg">
              ...
              video content, and there are two types: auto-generated by YouTube
              and created by the video owner. While auto-generated thumbnails
              save time, personalized thumbnails let you add your own branding
              and style. Six recommendations for creating professional
              thumbnails are given, including dimensions, font guidelines,
              branding, readability, high-quality images, and thumbnail style
              experimentation. Busy thumbnails should be avoided, and the
              article concludes with tips for uploading customized thumbnails to
              YouTube. The article also includes frequently asked questions
              about using templates, the number of custom thumbnails a channel
              can upload per day, editing published video thumbnails, and the
              use of clickbait thumbnails.
            </span>
            <div className="inline-flex space-x-2 items-center">
